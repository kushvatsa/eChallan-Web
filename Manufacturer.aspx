<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Manufacturer.aspx.cs" Inherits="Manufacturer" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div style="height: 216px">
        <div class="client_heading">
            <asp:Label ID="lblHead" runat="server" Text="New Manufacturer"></asp:Label>
        </div>
        ...
        <div>
            <div style="float:right; width:180px">
                <asp:DropDownList ID="ddlManufacturer" runat="server" style="width:170px" 
                    AutoPostBack="True" DataTextField="Name" DataValueField="ManufacturerID" 
        ...
        <div class="info_cntnt">
            <div class="cntnt_value">ManufacturerID:</div>
