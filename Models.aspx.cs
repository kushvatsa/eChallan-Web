...
public partial class _Default : System.Web.UI.Page
{
    ...
    void InitForNew()
    {
        ...
        FillList();
        ddlModels.Items.Insert(0, "----Select----");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            con.Open();
            string sp;
            if (btnSave.Text == "Add") sp = "AddModel";
            else sp = "UpdateModel";
            ...
            if (btnSave.Text == "Update") cmd.Parameters.Add("@ModelID", System.Data.SqlDbType.Int).Value = txtID.Text;
    ...
    void FillList()
    {
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT ModelID, Name FROM Models ORDER BY Name", con);
            cmd.CommandType = System.Data.CommandType.Text;

            SqlDataReader dr;
            dr = cmd.ExecuteReader();
            ddlModels.DataSource = dr;
            ddlModels.DataBind();
        }
        catch (Exception ex)
        {
    ...
    protected void ddlManufacturer_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string sql;
            sql = string.Format("SELECT ModelID, Name, Remarks FROM Models WHERE ModelID={0}", ddlModels.SelectedValue);
            ...
            while (dr.Read())
            {
                txtID.Text = dr["ModelID"].ToString();
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cmd.Parameters.Add("ModelID", System.Data.SqlDbType.Int).Value = txtID.Text;
