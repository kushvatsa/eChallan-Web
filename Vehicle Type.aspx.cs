...
public partial class Vehicle_Type : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            con.Open();
            string sp;
            if(btnSave.Text == "Add") sp = "AddVehicleType";
            else sp = "UpdateVehicleType";
            ...
            if(btnSave.Text == "Update") cmd.Parameters.Add("@VehicleTypeID", System.Data.SqlDbType.Int).Value = txtID.Text;
    ...
    void FillList()
            ...
            try
        {
            ...
            string sql;
            sql = string.Format("SELECT VehicleTypeID, Name, Remarks FROM [Vehicle Types] WHERE VehicleTypeID={0}", ddlVehicleType.SelectedValue);
            ...
            while (dr.Read())
            {
                txtID.Text = dr["VehicleTypeID"].ToString();
            ...
            //  Form settings
            lblHead.Text = "Update Vehicle Type";
            lblMsg.Text = "";
            btnSave.Text = "Update";
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("DeleteVehicleType", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;

                cmd.Parameters.Add("VehicleTypeID", System.Data.SqlDbType.Int).Value = txtID.Text;
