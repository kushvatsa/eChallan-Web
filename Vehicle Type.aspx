<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Vehicle Type.aspx.cs" Inherits="Vehicle_Type" %>
...
<div style="height: 214px; margin-bottom: 0px;">
 <div class="client_heading">
            <asp:Label ID="lblHead" runat="server" Text="New Vehicle Type"></asp:Label>
        </div>
        ...
        <div>
            <div style="float:right; width:180px">
                <asp:DropDownList ID="ddlVehicleType" runat="server" style="width:170px" 
                    AutoPostBack="True" DataTextField="Name" DataValueField="VehicleTypeID" 
        ...
        <div class="info_cntnt">
            <div class="cntnt_value">VehicleTypeID:</div>
        ...
        <div class="info_txt" style="width:180px;">
            ...
            <div class="cntnt_value ">
                <asp:TextBox ID="txtName" runat="server" width="150" OnKeyPress="return alphanumeric(event)"></asp:TextBox>
            </div>
